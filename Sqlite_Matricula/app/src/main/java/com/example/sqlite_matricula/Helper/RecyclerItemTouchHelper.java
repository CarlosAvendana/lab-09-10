package com.example.sqlite_matricula.Helper;
...
public class RecyclerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        ...
        if (this.listener.getClass().getSimpleName().equals("List_Matricula") || this.listener.getClass().getSimpleName().equals("List_Desmatricula"))
                swipeFlags=0;
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            //check adapter
            if (this.listener.getClass().getSimpleName().equals("List_Estudiante")) {
            ...
            } else if (this.listener.getClass().getSimpleName().equals("List_Cursos")) {
